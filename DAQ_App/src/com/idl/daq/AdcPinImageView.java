...
public class AdcPinImageView extends ImageView{
        ...
        public AdcPinImageView(Context context, AttributeSet attr) {
                super(context, attr);
                c=context;
                initialize();
        }
        public AdcPinImageView(Context context) {
                super(context);
                initialize();
        ...
        public boolean onTouchEvent(MotionEvent event) {
                ...
                case MotionEvent.ACTION_POINTER_2_DOWN:
        	            ...
        	            //Toast.makeText(c,"X:"+x+" "+relativeX+" Y:"+y+" "+relativeY+"sc"+getScale(), Toast.LENGTH_SHORT).show();
                        ...
                        if (event.getPointerCount() <= 1) {
                                ...
                                if (isDoubleTap) {
                                        if (30 > Math.abs(mDoubleTapX - event.getX())
                                                ...
                                                if(getScale()>1.0)
                                                Toast.makeText(c,"Touch to select a pin", Toast.LENGTH_SHORT).show();
                                                cutting();
        ...
        public void setRectVal(int t,int b,int l,int r){
        	leftx=l;
            topy=t;
            rightx=r;
            bottomy=b;
        ...
        public void onDraw(Canvas canvas) {
            ...
            float left=getX(leftx);
            float right=getX(rightx);
            float top=getY(topy);
            float bottom=getY(bottomy);
            drawRect.set(left, top, right, bottom);
            //Toast.makeText(c,"left"+left+" right"+right, Toast.LENGTH_SHORT).show();
            //Toast.makeText(c,"left"+top+" right"+bottom, Toast.LENGTH_SHORT).show();
            ...
            paint.setColor(Color.YELLOW);
            canvas.drawRoundRect(drawRect,10,10, paint);
            
            }
            
            	
        }
        protected float getX(float a)
        {
